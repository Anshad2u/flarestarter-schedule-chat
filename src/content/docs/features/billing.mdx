...
- 登录后的 app 顶部显示 [`PaymentFailedBanner`](https://github.com/softfactory/softfactory/blob/main/src/features/billing/components/payment-failed-banner.tsx):"上次扣款失败,请更新支付方式" → 跳 Stripe Customer Portal 换卡。
